...
$db = dbConn();
$sql = "SELECT o.*,u.FirstName,u.LastName FROM orders o INNER JOIN customers c ON c.CustomerId=o.customer_id INNER JOIN users u ON u.UserId=c.UserId WHERE o.id='$order_id'";
$result = $db->query($sql);
    ...
    <div class="col-12">
        ...
        <div class="card">
            ...
            <div class="card-body table-responsive p-0">
                ...
                <!-- COALESCE- if value null convert to 0 -->
                <?php
                $db = dbConn();
                echo $sql = "SELECT 
    o.order_id,
...
FROM 
    order_items o 
INNER JOIN 
    products p ON p.P_Id = o.item_id 
LEFT JOIN 
    (
        SELECT 
            item_id,
