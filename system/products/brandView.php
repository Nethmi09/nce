    ...
    <div class="col-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                $sql = "SELECT BrandId,BrandImage,BrandName,BDescription, m.MainCategoryName FROM brands b INNER JOIN main_categories m ON m.MainCategoryId=b.MainCategoryId WHERE b.BrandID='$brandid'";
                $result = $db->query($sql);
