                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            <label for="warranty" class="form-label fw-bold">Warranty<span style = "color: red"> * </span></label>
                            <input type="text" name="warranty" class="form-control mb-1" id="warranty" value="<?= @$warranty ?>" placeholder="Enter Batch Number" required>
