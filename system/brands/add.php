...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($message)) {
        ...
        $db = dbConn();
        $sql = "INSERT INTO brands(BrandImage,BrandName,Description,MainCategoryId,Status) VALUES ('$brand_image', '$brand_name','$description','$main_category','1')";
        $db->query($sql);
...
<div class="row">
    ...
    <div class="col-12">
        ...
        <!--Card Start-->
        <a href="<?= SYS_URL ?>brands/manage.php" class="btn btn-dark mb-4"><i class="fas fa-arrow-left"></i> Back to Brands Details Table</a>
        <div class="card">
