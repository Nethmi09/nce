...
<div class="row">
    <div class="col-12">
        ...
        <a href="<?= SYS_URL ?>orderIssue/manage.php" class="btn btn-dark mb-4"><i class="fas fa-arrow-left"></i> Back to order List</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php } else {
                                                ...
                                                <input type="number" min='1' name="issued_qty[]" max="<?= $row['balance_qty'] ?>">
                                            <?php } ?>
                                        </td>
                                    </tr>
